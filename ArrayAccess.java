...
try
{
// I will use inputField.getText() to catch any non-integer values
...
// I will initialize to false "numValue not found"
...
if(num == array[count])
{
// If the number found in the array it will be printed as String "result"
numValue = true;
result += count + "  ";
}
}
// If not found in the array throw exception
if(numValue != true)
{
throw new NumberNotFoundException();
}
else
// If the number found print message number found in ...
outputField.setText(num + " found in: " + result);
}
...
stored a value, an ArrayIndexOutOfBoundsException should be thrown. */
try
{
